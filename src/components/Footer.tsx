    ...
    <footer className="bg-hotel-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Column 1 - About */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Grand Hotel</h3>
            <p className="text-hotel-accent mb-6">
              Experience luxury and comfort in the heart of the city, where every detail is crafted for your perfect stay.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>123 Luxury Ave, City Center<br/>New York, NY 10001</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-3 h-5 w-5 text-hotel-gold" />
                <a href="tel:+12125551234" className="hover:text-hotel-gold transition-colors">+1 (212) 555-1234</a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 h-5 w-5 text-hotel-gold" />
                <a href="mailto:info@grandhotel.com" className="hover:text-hotel-gold transition-colors">info@grandhotel.com</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['About Us', 'Rooms & Suites', 'Dining', 'Spa & Wellness', 'Events', 'Gallery', 'Offers', 'Careers'].map((item) => (
                <li key={item}>
                  <Link to={`/${item.toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-hotel-gold transition-colors">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-hotel-accent mb-4">Subscribe to our newsletter for special offers and updates</p>
            <form className="mb-4">
              <div className="flex">
                <input 
                  type="email" 
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center md:text-left md:flex md:justify-between text-sm text-hotel-accent">
          ...
          <p className="mt-2 md:mt-0">
            ...
            <Link to="/terms" className="hover:text-hotel-gold transition-colors ml-2">Terms of Service</Link>
          </p>
        </div>
      </div>
    </footer>
